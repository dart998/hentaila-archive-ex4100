...
| Imagen | `ovelayos/hentaila-archive-ex4100:0.1.5` |
...
El workflow `.github/workflows/docker.yml` comprueba el changelog, compila para ARMv7 y publica las etiquetas `0.1.5` y `latest` en Docker Hub. El repositorio necesita los secretos `DOCKERHUB_USERNAME`, `DOCKERHUB_TOKEN` y `PORTAINER_WEBHOOK_URL`.
